...
class GenerationNet(nn.Module):
    ...
    def forward(self, h_sample):
        ...
        for c in range(self.n_classes):
            p_v.append(self.v_hc_list[c](h_sample).unsqueeze(1)) # [M * bs, 1, channel, imagesize, imagesize]
        p_v = torch.cat(p_v, axis = 1) # [M * bs, n_classes, channel, imagesize, imagesize]
        return p_v
