...
def arg_parser():
    ...
    parser.add_argument('--h_weight', type = float, default = 2.0)
    parser.add_argument('--w_weight', type = float, default = 2.0)
    parser.add_argument('--c_weight', type = float, default = 0.4)
    parser.add_argument('--lam', type = float, default=2.7)
